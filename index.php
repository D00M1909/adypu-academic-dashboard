...
<body>
  ...
  <main>
    ...
    <section class="stat-row">
      <button class="stat-hero" id="present-today-card" type="button">
        ...
        <span class="stat-hero-cta">View breakdown<svg class="stat-hero-cta-icon">
      ...
      <div class="stat-strip">
        ...
        <button class="stat-pill stat-action" id="pdf-report-card" type="button">
          <svg class="stat-action-icon">
            <use href="#icon-pdf" />
          </svg>
          <span class="stat-pill-value">PDF</span>
          <span class="stat-pill-label">PDF Report</span>
          <span class="stat-action-desc">Export Report</span>
        </button>
      </div>
    </section>
        ...
        <div class="tile-grid schools-grid">
          ...
          ?>
            <button class="tile school-tile" type="button" data-school="<?= htmlspecialchars($id) ?>">
              <svg class="tile-icon-svg">
                <use href="#icon-<?= htmlspecialchars($id) ?>" />
              </svg>
    ...
    <div class="modal" role="dialog" aria-modal="true" aria-labelledby="modal-title">
      <div class="modal-header">
        ...
        <div class="modal-actions">
          <button id="modal-refresh" class="icon-btn" type="button" aria-label="Refresh"><svg>
              <use href="#icon-refresh" />
            </svg></button>
          <button id="modal-close" class="icon-btn" type="button" aria-label="Close"><svg>
              <use href="#icon-x" />
            </svg></button>
        </div>
      </div>
  ...
  <div id="pdf-report-modal" class="modal-backdrop" hidden>
    <div class="modal pdf-report-modal" role="dialog" aria-modal="true" aria-labelledby="pdf-report-title">
      <div class="modal-header">
        <div class="modal-heading">
          <h2 id="pdf-report-title">Attendance PDF Report</h2>
          <p class="modal-subtitle">Select the attendance date range to export.</p>
        </div>
        <div class="modal-actions">
          <button id="pdf-report-close" class="icon-btn" type="button" aria-label="Close"><svg>
              <use href="#icon-x" />
            </svg></button>
        </div>
      </div>
      <form id="pdf-report-form" class="pdf-report-form" novalidate>
        <label class="form-field" for="pdf-from-date">
          <span>From Date</span>
          <input id="pdf-from-date" name="from" type="date" required>
        </label>
        <label class="form-field" for="pdf-to-date">
          <span>To Date</span>
          <input id="pdf-to-date" name="to" type="date" required>
        </label>
        <p id="pdf-report-error" class="form-error" role="alert" hidden></p>
        <div class="form-actions">
          <button id="pdf-report-cancel" class="btn btn-secondary" type="button">Cancel</button>
